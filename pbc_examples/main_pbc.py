...
parser.add_argument('--nu', type=float, default=5.0, help='nu value that scales the d^2u/dx^2 term. 0 if only doing advection.')
parser.add_argument('--rho', type=float, default=5.0, help='reaction coefficient for u*(1-u) term.')
